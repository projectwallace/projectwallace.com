<script lang="ts">
	...
	import { validate as validate_duration } from '#lib/sort-time.ts'
	...
	import { design_token_tabs, type TabId } from '#lib/components/devtools/tabs.ts'
	...
	import { normalize_line_height } from '#lib/sort-line-height.ts'
