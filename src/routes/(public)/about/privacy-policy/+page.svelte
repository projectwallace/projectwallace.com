...
<section>
	<Container>
		<MarkdownContent>
			...
			<p>
				We only collect the information that you provide us with. We only need a very minimal set of
				information to create an account for you and let you work on our website. We don't sell your
				data to any third party.
			</p>

			<h2>The full version</h2>
			<p>
				Your privacy is important to us. It is Project Wallace&rsquo;s policy to respect your
				privacy regarding any information we may collect from you across our website,
				https://www.projectwallace.com, and other sites we own and operate.
			</p>
			<p>
				...
				why we&rsquo;re collecting it and how it will be used.
			</p>
			<p>
				We only retain collected information for as long as necessary to provide you with your
				requested service. What data we store, we&rsquo;ll protect within commercially acceptable
				means to prevent loss and theft, as well as unauthorised access, disclosure, copying, use or
				modification.
			</p>
			<p>
				We don&rsquo;t share any personally identifying information publicly or with third-parties,
